...
{{--        <form className="display-inline" method="POST" action={{route('admin.product.destroy', [$record->id]  )}}>--}}
{{--            @csrf--}}
{{--            @method('delete')--}}
{{--            <button type="submit" className="waves-effect waves-light btn gradient-45deg-light-warning-cyan z-depth-4">--}}
{{--                Delete--}}
{{--            </button>--}}
{{--        </form>--}}
